This sample provides an end-to-end walkthrough of a canonical scenario of log processing using Azure Data Factory to transform data from log files into insights.
...
Refer to http://azure.microsoft.com/en-us/documentation/articles/data-factory-tutorial/
